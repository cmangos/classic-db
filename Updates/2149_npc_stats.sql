...
UPDATE creature_template SET DamageMultiplier=2.6, MinMeleeDmg=66, MaxMeleeDmg=90, MinRangedDmg=47, MaxRangedDmg=69, MeleeAttackPower=218, RangedAttackPower=22, MeleeBaseAttackTime=1500, RangedBaseAttackTime=1500 WHERE entry=12418; -- Gordok Hyena 2.6
