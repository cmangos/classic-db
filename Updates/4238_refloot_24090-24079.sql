...
-- 60300	NPC LOOT (Purple World Drop) - (Item Levels: 40-43) - (NPC Levels: 39-40)
...
REPLACE INTO `creature_loot_template` (`entry`, `item`, `mincountorref`, `chanceorquestchance`, `groupid`, `maxcount`)
SELECT `entry`, 60316, -60316, 0.004, 0, 1 FROM `creature_template` WHERE `entry` = -- 6 Items
...
9026 -- Overmaster Pyron	52	52 -- 51-51 tbc+
);
REPLACE INTO `reference_loot_template` (`entry`, `item`, `ChanceOrQuestChance`, `groupid`, `mincountOrRef`, `maxcount`, `condition_id`, `comments`) VALUES
...
10919, -- Shatterspear Troll	57	57 -- use 55 due to scrolls III - https://web.archive.org/web/20071030063647/http://wow.allakhazam.com/db/mob.html?wmob=10919
...
UPDATE `reference_loot_template_names` SET `name` = 'NPC LOOT (Purple World Drop) - (Item Levels: 40-43) - (NPC Levels: 39-40)' WHERE `entry` = 60300;
...
DELETE FROM `creature_loot_template` WHERE (`mincountorref` BETWEEN -24090 AND -24079) AND `entry` IN (
