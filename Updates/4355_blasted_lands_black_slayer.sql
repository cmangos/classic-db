...
DELETE FROM `creature` WHERE (`guid` IN (3836, 3837, 3838, 3938)); -- Black Slayer
DELETE FROM `creature` WHERE (`guid` IN (3839, 3916, 3918, 3928, 3929)); -- Bonebiter, does not exist in classic-wow
DELETE FROM `creature` WHERE (`guid` IN (3896, 3898)); -- 2 Scorpid Stinger, these are always Black Slayer in classic-wow
DELETE FROM `creature` WHERE (`guid` IN (3860, 3905)); -- 2 Wretched Lost One, can also spawn as Black Slayer in classic-wow
...
(@SGUID + 000, 'Blasted Lands - Black Slayer (1) Patrol 000', 0, 0, 0, 0, 0),
(@SGUID + 001, 'Blasted Lands - Black Slayer (1) Patrol 001', 0, 0, 0, 0, 0),
(@SGUID + 002, 'Blasted Lands - Black Slayer (1) Wandering 000', 0, 0, 0, 0, 0),
(@SGUID + 003, 'Blasted Lands - Black Slayer (1) Wandering 001', 0, 0, 0, 0, 0),
(@SGUID + 004, 'Blasted Lands - Black Slayer (1) Wandering 002', 0, 0, 0, 0, 0),
(@SGUID + 005, 'Blasted Lands - Black Slayer (1) Wandering 003', 0, 0, 0, 0, 0),
(@SGUID + 006, 'Blasted Lands - Black Slayer (1) Wandering 004', 0, 0, 0, 0, 0),
(@SGUID + 007, 'Blasted Lands - Black Slayer (1) Wandering 005', 0, 0, 0, 0, 0),
(@SGUID + 008, 'Blasted Lands - Black Slayer (1) Wandering 006', 0, 0, 0, 0, 0),
(@SGUID + 009, 'Blasted Lands - Black Slayer (1) Wandering 007', 0, 0, 0, 0, 0),
(@SGUID + 010, 'Blasted Lands - Black Slayer (1) Wandering 008', 0, 0, 0, 0, 0),
(@SGUID + 011, 'Blasted Lands - Wretched Lost One | Black Slayer (1) Patrol 000', 0, 0, 0, 0, 0),
(@SGUID + 012, 'Blasted Lands - Wretched Lost One | Black Slayer (1) Patrol 001', 0, 0, 0, 0, 0),
(@SGUID + 013, 'Blasted Lands - Wretched Lost One | Black Slayer (1) Patrol 002', 0, 0, 0, 0, 0);
...
(@SGUID + 000, 5982, 0, 0, 0),
(@SGUID + 001, 5982, 0, 0, 0),
(@SGUID + 002, 5982, 0, 0, 0),
(@SGUID + 003, 5982, 0, 0, 0),
(@SGUID + 004, 5982, 0, 0, 0),
(@SGUID + 005, 5982, 0, 0, 0),
(@SGUID + 006, 5982, 0, 0, 0),
(@SGUID + 007, 5982, 0, 0, 0),
(@SGUID + 008, 5982, 0, 0, 0),
(@SGUID + 009, 5982, 0, 0, 0),
(@SGUID + 010, 5982, 0, 0, 0),
(@SGUID + 011, 5979, 0, 0, 0), (@SGUID + 011, 5982, 0, 0, 0),
(@SGUID + 012, 5979, 0, 0, 0), (@SGUID + 012, 5982, 0, 0, 0),
(@SGUID + 013, 5979, 0, 0, 0), (@SGUID + 013, 5982, 0, 0, 0);
