...
/* Canon */
DELETE FROM `gameobject` WHERE `guid`=12764;
...
DELETE FROM `game_event_gameobject` WHERE `guid`=12764;
...
/* NPC */
DELETE FROM `creature` WHERE `guid`=52413;
...
DELETE FROM `game_event_creature` WHERE `guid`=52413;
...
DELETE FROM `spell_target_position` WHERE `id`=24730;
DELETE FROM `spell_target_position` WHERE `id`=24831;
