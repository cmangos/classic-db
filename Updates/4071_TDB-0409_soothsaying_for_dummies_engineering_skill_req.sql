...
-- Use condition 393 instead of 10997 "Has Skill ID 202, Minimum Skill Value 200"
UPDATE `conditions` SET `value2` = 393, `comments`="((NOT Player Has Learned Spell: 20219 AND NOT Player Has Learned Spell: 20222) AND (Quest ID 3639 Rewarded OR (Quest ID 3643 Rewarded OR Quest ID 3641 Rewarded))) AND Has Skill ID 202, Minimum Skill Value 200"
