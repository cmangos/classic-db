...
-- Small Thorium Vein
DELETE FROM `gameobject` WHERE (`guid` IN (33, 134, 135, 136, 138, 139, 140, 141, 142, 143, 147, 152, 157, 171, 186, 195, 200, 204, 222, 223, 234, 235, 243, 254, 257, 294, 313, 319, 326, 335, 341, 343, 386,
49322, 49323, 49324, 49325, 49326, 49327, 49328, 49329, 49330, 49331, 120264));
DELETE FROM `pool_gameobject` WHERE (`guid` IN (33, 134, 135, 136, 138, 139, 140, 141, 142, 143, 147, 152, 157, 171, 186, 195, 200, 204, 222, 223, 234, 235, 243, 254, 257, 294, 313, 319, 326, 335, 341, 343, 386,
49322, 49323, 49324, 49325, 49326, 49327, 49328, 49329, 49330, 49331, 120264));
