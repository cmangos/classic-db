SELECT * FROM instance_template WHERE map=169;
INSERT INTO instance_template (map, parent, ScriptName, mountAllowed, ghostEntranceMap, ghostEntranceX, ghostEntranceY) VALUES
(169, 0, '', 0, 0, 0, 0);
