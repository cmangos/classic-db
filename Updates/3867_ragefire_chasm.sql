DELETE FROM creature_addon WHERE guid IN (SELECT guid FROM creature WHERE map=389);
DELETE FROM creature_linking WHERE guid IN (SELECT guid FROM creature WHERE map=389);
DELETE FROM creature_movement WHERE id IN (SELECT guid FROM creature WHERE map=389);
...
UPDATE creature_template_addon SET auras='18268' WHERE entry=11321;
UPDATE creature_template_addon SET auras='3616' WHERE entry=11519;
