...
DELETE FROM pool_template WHERE entry=45101;
DELETE FROM pool_gameobject WHERE pool_entry=45101;
DELETE FROM creature_addon WHERE guid IN (79082, 79095, 79097, 79103, 79106);
