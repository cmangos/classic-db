...
('account create',3,'Syntax: .account create $account $passwordCreate account and set password to it.'),
('account delete',3,'Syntax: .account delete $accountDelete account with all characters.'),
('account lock',0,'Syntax: .account lock [on|off]Allow login from account only from current used IP or remove this requirement.'),
('account onlinelist',3,'Syntax: .account onlinelistShow list of online accounts.'),
...
('server exit',3,'Syntax: .server exitTerminate mangosd NOW. Exit code 0.'),
