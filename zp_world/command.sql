...
('account set addon',3,'Syntax: .account set addon [$account] #addonSet user (possible targeted) expansion addon level allowed. Addon values: 0 - normal, 1 - tbc, 2 - wotlk.'),
('account set gmlevel',4,'Syntax: .account set gmlevel [$account] #levelSet the security level for targeted player (can\'t be used at self) or for account $name to a level of #level.#level may range from 0 to 3.'),
('account set password',4,'Syntax: .account set password $account $password $passwordSet password for account.'),
...
('character delete',4,'Syntax: .character delete $nameDelete character $name.'),
...
('debug getvalue',3,'Syntax: .debug getvalue #field #isIntGet the field #field of the selected creature. If no creature is selected, get the content of your field.Use a #isInt of value 1 if the expected field content is an integer.'),
('debug Mod32Value',3,'Syntax: .debug Mod32Value #field #valueAdd #value to field #field of your character.'),
...
('debug setvalue',3,'Syntax: .debug setvalue #field #value #isIntSet the field #field of the selected creature with value #value. If no creature is selected, set the content of your field.Use a #isInt of value 1 if #value is an integer.'),
('debug update',3,'Syntax: .debug update #field #valueUpdate the field #field of the selected character or creature with value #value.If no #value is provided, display the content of field #field.'),
...
('modify bit',1,'Syntax: .modify bit #field #bitToggle the #bit bit of the #field field for the selected player. If no player is selected, modify your character.'),
