...
(3,0,4,1,3,0,0,'I want to browse your goods',NULL),
(4,0,8,2,4,0,0,'I want to travel fast',NULL),
(5,0,16,3,5,0,0,'Train me!',NULL),
(6,0,32,4,6,0,0,'Bring me back to life',NULL),
(7,0,64,5,7,0,0,'Unknown',NULL),
(8,0,128,5,8,0,0,'Make this inn my home',NULL),
(9,0,256,6,9,0,0,'Show me my bank',NULL),
(10,0,512,7,10,0,0,'How do I form a guild?',NULL),
(11,0,1024,8,11,0,0,'I want to create a guild crest.',NULL),
(12,0,2048,10,12,0,0,'I want to join the Battle Ground.',NULL),
(13,0,4096,11,13,0,0,'Auction!',NULL),
(14,0,8192,12,14,0,0,'UNIT_NPC_FLAG_STABLE',NULL),
(15,0,16384,13,15,0,0,'UNIT_NPC_FLAG_ARMORER',NULL),
