...
ALTER TABLE `creature_ai_scripts`  ORDER BY `id` ASC;
...
ALTER TABLE `creature_movement_scripts`  ORDER BY `id` ASC;
...
ALTER TABLE `event_scripts`  ORDER BY `id` ASC;
...
ALTER TABLE `gameobject_scripts`  ORDER BY `id` ASC;
...
ALTER TABLE `gossip_scripts`  ORDER BY `id` ASC;
...
ALTER TABLE `quest_end_scripts`  ORDER BY `id` ASC;
ALTER TABLE `quest_start_scripts`  ORDER BY `id` ASC;
...
ALTER TABLE `spell_scripts`  ORDER BY `id` ASC;
