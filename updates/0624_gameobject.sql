...
(@GUID + 8, '180691', '509', '-9006.972', '1988.604', '32.23689', '6.161013', '0', '0', '-0.06104851', '0.9981348', @RESP, '100', '1');
-- (@GUID + 9, '180691', '509', 'x', 'y', 'z', 'o', '0', '0', 'r2', 'r3', @RESP, '100', '1'); -- last one is still missing
